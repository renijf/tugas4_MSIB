    ...
    <div class="card shadow border-0 my-5 p-3">
        <card-body>
            <div class="row mb-5">
                ...
                <div class="col-auto">
                    <a href="{{route('cart.index')}}" class="btn btn-outline-primary btn-lg">Go Back</a>
                </div>
            </div>
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-3">
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="text" name="qty" value="{{$cart->qty}}" id="" class="form-control @error('name') is-invalid @enderror">
                                    @error('name')
                                        <small class="my-1 text-danger fw-bold">{{$message}}</small>
                                    @enderror
                                </div>
